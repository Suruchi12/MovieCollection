...
class UpcomingTableViewController: UITableViewController{
    ...
    func downloadJSON(completed: @escaping () -> ()){
        ...
        let url = URL(string: "https://api.themoviedb.org/3/movie/upcoming?api_key=appikey")
...
//        let finalRating = String(format: "%.0f",rating!)
        let releaseDate = results?.movies[indexPath.row].releaseDate
        ...
        //cell.detailTextLabel?.text?.append("\(releaseDate!)")
