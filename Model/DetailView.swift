...
class DetailHeader: UIView{
    var movie: MovieInfo?{
        didSet{
            ...
            releaseDate.text?.append((movie?.releaseDate)!)
    ...
    func setupViews(){
        ...
        let stackView:UIStackView = {
            ...
            addConstraintsWithFormat(format: "V:[v0][v1(20)][v2]|", views: starRating,releaseDate,originalTitle)
...
//            addConstraintsWithFormat(format: "V:[v0(20)]|", views: starRating)
        ...
        addConstraintsWithFormat(format: "V:|-40-[v0]|", views: stackView)
